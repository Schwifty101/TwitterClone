    ...
    return (
        <FlexBetween padding="1rem 6%" backgroundColor={alt} boxShadow={1}>
            ...
            <FlexBetween gap='2rem'>
                ...
                <FormControl varient="standard" value={fullName} onChange={(e) => console.log(e.target.value)}>
                    <Select
                        value={fullName}
                        sx={{
            ...
            {isMobileMenuToggle && (
                ...
                >
                    <IconButton
                        onClick={() => setIsMobileMenuToggle(false)}
                    ...
                    <FlexBetween flexDirection='column' gap='2rem'>
                        ...
                        <Notifications sx={{ fontSize: '25px' }} />
                        <Help sx={{ fontSize: '25px' }} />
                        <FormControl variant="standard" value={fullName} onChange={(e) => console.log(e.target.value)}>
                            <Select
                                value={fullName}
                                sx={{
                                    backgroundColor: neutralLight,
